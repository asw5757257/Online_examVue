...
export default {
    ...
    methods:{
        showMajor(scope){
             this.axios.get(this.global.baseURL+"/manage/getTeacherAndMajor",
       {params:{
               id:scope.row.id,
       ...
       {params:{
        ...
        delMajor(props){
            ...
            this.axios.get(this.global.baseURL+"/manage/delTeacherAndMajor",
       {params:{
               mid:props.row.id,
               tid:this.id
        ...
        addMajor(){
            this.axios.get(this.global.baseURL+"/manage/addTeacherAndMajor",
            {params:{
               mid:this.value,
               tid:this.addId
