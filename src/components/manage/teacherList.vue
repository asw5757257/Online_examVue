...
export default {
    ...
    methods:{
        getTeacherList(){
            this.axios.get(this.global.baseURL+"/manage/queryTeacher",
       {params:{
        ...
        addTeacher(){
            this.$refs.addFormRef.validate(async valid=>{
                ...
                this.axios.post(this.global.baseURL+"/manage/addOrModifyTeacher",this.addForm).
                then((response)=>{
                    let res = response.data
                    if(res.state == 0){
        ...
        editTeacherInfo(){
            this.$refs.editFormRef.validate(valid=>{
                if(!valid) return
                this.axios.post(this.global.baseURL+"/manage/addOrModifyTeacher",this.editForm).
                then((response)=>{
                    let res = response.data
                    if(res.state == 0){
        ...
        removeTeacher(id){
          ...
          type: 'warning'
            ...
            this.axios.get(this.global.baseURL+"/manage/delTeacher",{
                    params: {
                    id: id
                    }
                }).then((response)=>{
        ...
        resetPwd(id){
          ...
          type: 'warning'
            ...
            this.axios.get(this.global.baseURL+"/manage/resetTeacherPwd",{
                    params: {
                    id: id
                    }
                }).then((response)=>{
