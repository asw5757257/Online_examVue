...
export default {
    ...
    methods:{
        getMajor(){
            this.axios.get(this.global.baseURL+"/manage/queryMajor",
       {params:{
        ...
        addMajor(){
            this.$refs.addFormRef.validate(async valid=>{
                ...
                this.axios.post(this.global.baseURL+"/manage/addOrModifyMajor",this.addForm).
                then((response)=>{
                    let res = response.data
                    if(res.state == 0){
        ...
        editMajor(){
            this.$refs.editFormRef.validate(async valid=>{
                if(!valid || this.value == '') return
                this.axios.post(this.global.baseURL+"/manage/addOrModifyMajor",this.editForm).
                then((response)=>{
                    let res = response.data
                    if(res.state == 0){
        ...
        deleteMajor(scope){
            this.axios.get(this.global.baseURL+"/manage/delMajor",{params:{
               id:scope.row.id
           }}).
                then((response)=>{
                    let res = response.data
