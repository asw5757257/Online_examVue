...
export default {
    ...
    methods:{
        getMajorList(){
            this.axios.get(this.global.baseURL+"/manage/getMajor").
            then((response)=>{
              let res = response.data;
              this.majorList = res.object;})
        },
        getStudentList(){
            this.axios.get(this.global.baseURL+"/manage/queryStudent",
       {params:{
        ...
        addStudent(){
            this.$refs.addFormRef.validate(async valid=>{
                ...
                this.axios.post(this.global.baseURL+"/manage/addOrModifyStudent",this.addForm).
                then((response)=>{
                    let res = response.data
                    if(res.state == 0){
        ...
        editStudentInfo(){
            this.$refs.editFormRef.validate(valid=>{
                ...
                this.axios.post(this.global.baseURL+"/manage/addOrModifyStudent",this.editForm).
                then((response)=>{
                    let res = response.data
                    if(res.state == 0){
        ...
        removeStudent(id){
          ...
          type: 'warning'
            ...
            this.axios.get(this.global.baseURL+"/manage/delStudent",{
                    params: {
                    id: id
                    }
                }).then((response)=>{
        ...
        resetPwd(id){
          ...
          type: 'warning'
            ...
            this.axios.get(this.global.baseURL+"/manage/resetStudentPwd",{
                    params: {
                    id: id
                    }
                }).then((response)=>{
