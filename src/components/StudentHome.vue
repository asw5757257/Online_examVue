...
export default {
    ...
    return {
     ...
     methods:{
        ...
        getNoticeList(){
            this.axios.get(this.global.baseURL+"/notice/showNotice",
       {params:{
        ...
        getAllPaperList(){
            this.axios.get(this.global.baseURL+"/student/getAllPapers").then((response)=>{
              let res = response.data;
              if(res.state == 0){
        ...
        getUnfinish(){
            this.axios.get(this.global.baseURL+"/student/getUnfinishedPaper").then((response)=>{
              let res = response.data;
              if(res.state == 0){
                  return this.$message.error('获取试卷列表失败')
              }
        ...
        getScore(){
            ...
            this.axios.get(this.global.baseURL+"/student/queryScore").then((response)=>{
              let res = response.data;
              if(res.state == 0){
