    ...
    methods: {
      ...
      login(){
        this.$refs.loginFormRef.validate((valid)=>{
          ...
          if(this.value=='管理员'){
                this.axios.get(this.global.baseURL+"/manage/login",
            {
                params:{
            ...
            if(this.value=='教师'){
           this.axios.get(this.global.baseURL+"/teacher/login",
            {
                params:{
                    username:this.loginForm.username,
                    password:this.loginForm.password
            ...
            if(this.value=='学生'){
           this.axios.get(this.global.baseURL+"/student/login",
            {
                params:{
                    username:this.loginForm.username,
                    password:this.loginForm.password
      ...
      getCheckCode(){
        ...
        if(!reg.test(this.resetForm.email)){
          ...
          if(this.value=='学生'){
            this.axios.get(this.global.baseURL+"/student/getCheckCodeByEmail",
            {
                params:{
          ...
          if(this.value=='教师'){
            this.axios.get(this.global.baseURL+"/teacher/getCheckCodeByEmail",
            {
                params:{
                     email:this.resetForm.email
                }
      ...
      sendReset(){
        this.$refs.resetFormRef.validate((valid)=>{
          if(!valid) return
          if(this.value=='教师'){
           this.axios.get(this.global.baseURL+"/teacher/checkCheckCode",
            {
                params:{
                    email:this.resetForm.email,
            ...
            if(this.value=='学生'){
           this.axios.get(this.global.baseURL+"/student/checkCheckCode",
            {
                params:{
                    email:this.resetForm.email,
                    passwordNew:this.resetForm.passwordNew,
